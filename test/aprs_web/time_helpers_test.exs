defmodule AprsWeb.TimeHelpersTest do
  ...
  describe "time_ago_in_words/1" do
    ...
    test "returns '1 minute ago' for times a minute ago" do
      one_minute_ago = DateTime.utc_now() |> DateTime.add(-61, :second)
